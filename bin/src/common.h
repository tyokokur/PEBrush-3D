...
extern int Temp;
extern double lx, ly, lz, lz_cutoff, DGC_lzmax;
extern int Nx, Nx2, Nxc;
extern int Ny, Nz, Nz_cutoff, DGC_Nzmax;
...
//Numerical 
extern int and_NrMax, MAXMAX, and_rep_N;
...
extern double t_it, cut_it, t_dgc, cut_dgc, t_pb, cut_pb, t_free, cut_free, t_and, cut_and;
//Files
